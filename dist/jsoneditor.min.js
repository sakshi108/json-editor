...
if(this.enumSource=[],this.enum_display=[],this.enum_options=[],this.enum_values=[],this.original_parent_editors={},Object.assign(this.original_parent_editors,this.parent.editors),Array.isArray(this.schema.enumSource))for(b=0;b<this.schema.enumSource.length;b++)
...
if(this.enumSource[b].value&&(this.enumSource[b].value=this.jsoneditor.compileTemplate(this.enumSource[b].value,this.template_engine)),this.enumSource[b].title&&(this.enumSource[b].title=this.jsoneditor.compileTemplate(this.enumSource[b].title,this.template_engine)),this.enumSource[b].filter&&(this.enumSource[b].filter=this.jsoneditor.compileTemplate(this.enumSource[b].filter,this.template_engine)),this.enumSource[b].source&&"object"==typeof this.enumSource[b].source){var f=this.jsoneditor.expandRefs(this.enumSource[b].source);this.enumSource[b].source=[],this.enumSource[b].sourceByKey={};var g,h=Object.keys(f).sort();for(g=0;g<h.length;g++)this.enumSource[b].source.push(f[g]),this.enumSource[b].sourceByKey[f[g].title]=f[g]}}},build:function(){var a=this;this.options.compact||(this.header=this.label=this.theme.getFormInputLabel(this.getTitle())),this.schema.description&&(this.description=this.theme.getFormInputDescription(this.schema.description)),this.options.compact&&(this.container.className+=" compact"),this.input=this.theme.getSelectInput(this.enum_options),this.theme.setSelectOptions(this.input,this.enum_options,this.enum_display),(this.schema.readOnly||this.schema.readonly)&&(this.always_disabled=!0,this.input.disabled=!0),this.input.addEventListener("change",function(b){b.preventDefault(),b.stopPropagation(),a.onInputChange()}),this.control=this.theme.getFormControl(this.label,this.input,this.description),this.container.appendChild(this.control),this.value=this.enum_values[0]},addDynamicSchema:function(a,b){if(this.enumSource&&this.enumSource.length>0&&this.enumSource[0].hasOwnProperty("sourceByKey")){var c=this.parent,d=this.enumSource[0].sourceByKey[a],e=d.title;for(var f in c.editors)this.original_parent_editors.hasOwnProperty(f)||delete c.editors[f];
// Property is already added
if(c.editors[e])return;
// Property was added before and is cached
if(c.cached_editors[e]){if(c.editors[e]=c.cached_editors[e],b)return;c.editors[e].register()}else{var g=d.schema,h=c.jsoneditor.getEditorClass(g);if(c.editors[e]=c.jsoneditor.createEditor(h,{jsoneditor:c.jsoneditor,schema:g,path:c.path+"."+e,parent:c}),c.editors[e].preBuild(),!b){var i=c.theme.getChildEditorHolder();c.editor_holder.appendChild(i),c.editors[e].setContainer(i),c.editors[e].build(),c.editors[e].postBuild()}c.cached_editors[e]=c.editors[e]}
// If we're only prebuilding the editors, don't refresh values
b||(c.refreshValue(),c.layoutEditors())}},onInputChange:function(){var a=this.input.value;this.addDynamicSchema(a);var b;
// Invalid option, use first option instead
b=this.enum_options.indexOf(a)===-1?this.enum_values[0]:this.enum_values[this.enum_options.indexOf(a)],
// If valid hasn't changed
b!==this.value&&(
// Store new value and propogate change event
this.value=b,this.onChange(!0))},setupSelect2:function(){
